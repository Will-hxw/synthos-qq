...
# 或者，检查 Ollama 后启动全部服务，并自动创建 ngrok 公网 URL
bash run.sh
...
| `bash run.sh` | 完整开发环境 + ngrok 公网转发 | orchestrator, preprocessing, ai-model, data-provider, webui-backend, webui-frontend, ngrok |
